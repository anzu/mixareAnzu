...
public class DataView {
	...
	public static final int SEARCH_TERM_EVENTS = R.string.search_term_events;
	public static final int SEARCH_TERM_MERCHANDISE = R.string.search_term_merchandise;
	public static final int SEARCH_TERM_REFRESHMENTS = R.string.search_term_refreshments;
	public static final int SEARCH_TERM_RESTROOMS = R.string.search_term_restrooms;
	public static final int SEARCH_TERM_SOCIAL = R.string.search_term_social;
	...
	public void draw(PaintScreen dw) {
		...
		int markerCount = dataHandler.getMarkerCount();
		
		// Handle case where markerCount = 1
		if (markerCount == 1) {
			Marker ma = dataHandler.getMarker(0);

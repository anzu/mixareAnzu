...
public class MixListView extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		case 1:
			...
			dataSourceMenu.add("Events");
			dataSourceMenu.add("Merchandise");
			dataSourceMenu.add("Refreshments");
			dataSourceMenu.add("Restrooms");
			dataSourceMenu.add("Social");
			...
			dataSourceChecked.add(mixContext.isDataSourceSelected(DATASOURCE.EVENTS));
			dataSourceChecked.add(mixContext.isDataSourceSelected(DATASOURCE.MERCHANDISE));
			dataSourceChecked.add(mixContext.isDataSourceSelected(DATASOURCE.REFRESHMENTS));
			dataSourceChecked.add(mixContext.isDataSourceSelected(DATASOURCE.RESTROOMS));
			dataSourceChecked.add(mixContext.isDataSourceSelected(DATASOURCE.SOCIAL));
	...
	public void clickOnDataSource(int position){
		...
		switch(position){
			/*EVENTS*/
		case 0:
			mixContext.toogleDataSource(DATASOURCE.EVENTS);
			break;

			/*MERCHANDISE*/
		case 1:		
			mixContext.toogleDataSource(DATASOURCE.MERCHANDISE);
			break;

			/*REFRESHMENTS*/
		case 2:
			mixContext.toogleDataSource(DATASOURCE.REFRESHMENTS);
			break;

			/*RESTROOMS*/
		case 3:
			mixContext.toogleDataSource(DATASOURCE.RESTROOMS);
			break;

			/*SOCIAL*/
		case 4:
			mixContext.toogleDataSource(DATASOURCE.SOCIAL);
			break;
				/*WIKIPEDIA*/
		case 5:
...
class ListItemAdapter extends BaseAdapter {
	...
	public void colorSource(String source){
		...
		else if (source.equals("Merchandise"))
			changeColor(1, Color.WHITE, Color.DKGRAY);
		else if (source.equals("Refreshments"))
			changeColor(2, Color.WHITE, Color.DKGRAY);
		else if (source.equals("Restrooms"))
			changeColor(3, Color.WHITE, Color.DKGRAY);
		else if (source.equals("Social"))
			changeColor(4, Color.WHITE, Color.DKGRAY);
		else if (source.equals("Wikipedia"))
			changeColor(0, Color.WHITE, Color.DKGRAY);
